...
def segment_customers(input_data):
    ...
    pred_1 = 'unknown'
    if prediction == 0:
        pred_1 = 'Cluster 0: Highest no.of customers, Most of the households have atleast one kid, Majority of the households doesnt have any teens,  Majority of them did thet graduation and postgraduation, very few did their basic education, Low income, Low Expenditure, Very less purchases, Very less accepted campaign.'
    elif prediction == 1:
        pred_1 = 'Cluster 1: Cluster with Second highest no. of customers, Most of the households doesn’t have any kids, Majority of the households  have atleast one teen, Majority of them did they graduation and postgraduation, Low Income, Low Expenditure, Less than 20 purchases, Very less campaign accepted.'
    elif prediction == 2:
        pred_1 = 'Cluster 2: Most of the households doesn’t have any kids, Majority of the households doesn’t have any teens, Well Educated, Cluster with the highest income, High Expenditure, More than 20 purchases, Accepted a lot of campaigns.'
    elif prediction == 3:
        pred_1 = 'Cluster 3: Most of the households doesn’t have any kids, Majority of the households have atleast one teen, Well Educated, High income, High Expenditure, More than 25 purchases, Accepted a lot of campaigns.'
